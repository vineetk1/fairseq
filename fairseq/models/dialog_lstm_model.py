...
@register_model('dialog_lstm_model')
...
@register_model_architecture('dialog_lstm_model', 'dialog_lstm_base_model')
...
@register_model_architecture('dialog_lstm_model', 'dialog_lstm_model')
