...
def lstm_dialog(args):
    ...
    args.encoder_embed_path = getattr(args, 'encoder_embed_path', "examples/dialog/pretrained-word-vectors/glove.6B.300d.txt")
    ...
    args.decoder_embed_path = getattr(args, 'decoder_embed_path', "examples/dialog/pretrained-word-vectors/glove.6B.300d.txt")
